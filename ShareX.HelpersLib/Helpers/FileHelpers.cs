...
namespace ShareX.HelpersLib
{
    public static class FileHelpers
    {
        ...
        public static bool OpenFile(string filePath)
        {
            ...
            {
                MessageBox.Show(Localization.Strings.Helpers_OpenFile_File_not_exist_ + Environment.NewLine + filePath, "CrySnap",
        ...
        public static bool OpenFolder(string folderPath, bool allowMessageBox = true)
        {
            ...
            {
                MessageBox.Show(Localization.Strings.Helpers_OpenFolder_Folder_not_exist_ + Environment.NewLine + folderPath, "CrySnap",
                    MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
        ...
        {
            return BrowseFile("CrySnap - " + Localization.Strings.Helpers_BrowseFile_Choose_file, tb, initialDirectory, detectSpecialFolders, filter);
        }
        ...
        {
            return BrowseFolder("CrySnap - " + Localization.Strings.Helpers_BrowseFolder_Choose_folder, tb, initialDirectory, detectSpecialFolders);
        }
        ...
        public static string RenameFile(string filePath, string newFileName)
        {
            ...
            {
                MessageBox.Show(Localization.Strings.FileHelpers_Rename_file_error + "\r\n" + e.ToString(), "CrySnap - " + Localization.Strings.Error, MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
