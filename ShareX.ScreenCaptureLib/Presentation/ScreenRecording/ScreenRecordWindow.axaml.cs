...
public partial class ScreenRecordWindow : Window, IDisposable
{
        ...
        InvokeSafe(() =>
        {
            switch (state)
            {
                case ScreenRecordState.Waiting:
                    SetTrayText("CrySnap - " + Strings.ScreenRecordForm_StartRecording_Waiting___);
                ...
                case ScreenRecordState.Encoding:
                    Hide();
                    _trayMenu.Enabled = false;
                    SetTrayText("CrySnap - " + Strings.ScreenRecordForm_StartRecording_Encoding___);
    ...
    public void ChangeStateProgress(int progress)
    {
        InvokeSafe(() =>
        {
            SetTrayText($"CrySnap - {Strings.ScreenRecordForm_StartRecording_Encoding___} {progress}%");
    ...
    private void UpdateUI()
    {
        ...
        switch (Status)
        {
            case ScreenRecordingStatus.Working:
                SetTrayText("CrySnap - " + Strings.ScreenRecordForm_StartRecording_Click_tray_icon_to_stop_recording_);
